...
def setup_training_loop_kwargs(
    ...
    # Pre-trained model.
    pre_model    = None, # The names of the pre-trained models
    lamd       = None, # Set the hyperparameter of the loss function for pre-trained model
):
    ...
    ### -----------------------------------
    ### Pre-trained models: lamd,pre-pkl
    ### -----------------------------------
    args.lamd = lamd
